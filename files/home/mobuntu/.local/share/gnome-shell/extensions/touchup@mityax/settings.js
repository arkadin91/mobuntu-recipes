import { BoolSetting, EnumSetting, IntSetting, JSONSetting, StringListSetting, StringSetting } from './features/preferences/backend.js';
...
const settings = {
    ...
    osk: {
        keyPopups: {
             ...
             */
            style: new EnumSetting('osk-key-popups-style', 'accent'),
            /**
        ...
        spaceBarIMESwitching: {
             ...
             */
            indicatorMode: new EnumSetting('osk-space-bar-ime-switching-indicator-mode', 'current')
        }
    },
    screenRotateUtils: {
        /**
